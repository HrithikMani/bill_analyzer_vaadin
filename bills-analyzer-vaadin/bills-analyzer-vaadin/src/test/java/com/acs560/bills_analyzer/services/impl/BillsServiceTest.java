...
public class BillsServiceTest {
	...
	private static final Bill ANOTHER_BILL_TO_ADD = new Bill(11, 2099, AEP, 50.0);
	private static final Bill BILL_TO_ADD = new Bill(11, 2199, AEP, 50.0);
	private static final Bill DOESNT_EXIST = new Bill(5, 2124, DUMMY, 50.0);
	private static final Bill EXISTING_BILL = new Bill(11, 2023, AEP, 50.0);
	private static final Bill BILL_TO_DELETE = new Bill(5, 2024, AEP2, 50.0);
	...
	public void testUpdateBill_shouldUpdate() {
		...
		final Bill updatedBill = new Bill(month, year, new Company(companyId, name), newAmount);
